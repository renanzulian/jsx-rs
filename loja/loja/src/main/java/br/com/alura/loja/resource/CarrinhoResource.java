...
public class CarrinhoResource {
	...
	@PUT
	@Consumes(MediaType.APPLICATION_XML)
	public Response alterarProduto(@PathParam("id") long id, @PathParam("idProduto") long idProduto, String conteudo) {
		Carrinho carrinho = new CarrinhoDAO().busca(id);
	...
	@PUT
	@Consumes(MediaType.APPLICATION_XML)
	public Response trocaQuantidade(@PathParam("id") long id, @PathParam("idProduto") long idProduto, String conteudo) {
		Carrinho carrinho = new CarrinhoDAO().busca(id);
		Produto produto = (Produto) new XStream().fromXML(conteudo);
